...
class Downloader(object):
    ...
    def download_sequence(self):
        download_file_from_google_drive(file_id=self.sequence.calib.id, dest_path=self.sequence.calib.name,
                                            unzip=True)
        ...
        download_file_from_google_drive(file_id=self.sequence.poses.id, dest_path=self.sequence.poses.name,
                                            unzip=True)
        download_file_from_google_drive(file_id=self.sequence.images.id, dest_path=self.sequence.images.name,
                                            unzip=True)
